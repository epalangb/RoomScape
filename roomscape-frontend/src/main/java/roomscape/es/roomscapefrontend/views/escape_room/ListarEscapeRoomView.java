...
public class ListarEscapeRoomView extends javax.swing.JFrame implements Vista {
    ...
    private void initComponents() {
        ...
        buttonList.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                Context c = new Context(null, Event.ListarEscapeRoomOK);
    ...
    public void update(Context context) {
        if (context.getEvent() == Event.ListarEscapeRoomError)
            JOptionPane.showMessageDialog(null, context.getData(), "Atención", JOptionPane.INFORMATION_MESSAGE);
        else
            tableModel.update((ArrayList<TEscapeRoom>) context.getData());
    }
}
